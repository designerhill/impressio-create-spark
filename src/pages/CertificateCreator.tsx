        ...
        <div className="max-w-[1400px] mx-auto px-6">
          ...
          <header className="mt-4 mb-6">
            <nav className="flex items-center gap-1.5 text-xs font-medium text-slate-500 mb-4">
              ...
              <ChevronRight className="w-3.5 h-3.5" />
              <span className="text-slate-900">Certificate Creator</span>
            </nav>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-500 mt-0.5">
                    Professional, print-ready certificates with templates, AI copy and full control.
                  </p>
                </div>
              </div>
              <div className="flex items-center gap-2 text-xs text-slate-500">
                <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-white border border-slate-200">
                  <CircleDot className="w-3 h-3 text-emerald-500" /> Print ready
                </span>
              </div>
            </div>
          </header>
